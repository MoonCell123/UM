...
from _3_predictmodel.architecture.network import Classifier_1fc, DimReduction, DimReduction1
from einops import repeat
from .nystrom_attention import NystromAttention
from _3_predictmodel.modules.emb_position import *
...
class Attention_Gated(nn.Module):
    def __init__(self, L=512, D=128, K=1):
        ...
        self.learning = nn.Linear(self.L, self.D)
        self.relu = nn.ReLU()
        # nn.ReLU()
        # nn.Sigmoid()
        # nn.SiLU()
