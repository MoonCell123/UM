...
The LOO analysis reveals that different foundation models exhibit distinct contribution patterns across samples (Appendix Figure~\ref{fig:attribution_distribution}).
